      ...
      <section className="solutionclass">
        <div className="subsolclass">
          ...
          <div className="container">
            ...
            <div className="row solcardsclass" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '30px', justifyContent: 'center' }}>
              <div className="expandable-card" style={{ position: 'relative', overflow: 'hidden', transition: 'all 0.3s ease' }}>
                <div className="card-content" style={{ padding: '30px', textAlign: 'center', cursor: 'pointer' }}>
                  <img
                  ...
                  <p className="solcardtext expandable-text" style={{
                    maxHeight: '0',
                    overflow: 'hidden',
      ...
      <section className="recentworks">
        <div className="container">
          ...
          <div className="cardclass">
            <div className="row">
              <div className="col-md-4 cardcol" onClick={() => navigate('/ebooks')} style={{ cursor: 'pointer' }}>
              ...
              <div className="col-md-4 cardcol" onClick={() => navigate('/casestudies')} style={{ cursor: 'pointer' }}>
              ...
              <div className="col-md-4 cardcol" onClick={() => navigate('/blog/1')} style={{ cursor: 'pointer' }}>
          ...
          <div className="viewrecentbutton" onClick={() => navigate('/allinsights')} style={{ cursor: 'pointer' }}>
            View All Insights
            <svg
