...
const InfoBottom = () => {
    const items = [
        {
            title: "VALUE ATTAINED FASTER",
            icon: <CheckCircleOutline sx={{ fontSize: 40, color: '#158aff' }} />,
            points: [
                {
                    title: "",
                    text: "DataObserve accelerates value attainment in CPG with rapidity and precision."
                }
            ]
        },
        {
            ...
            points: [
                {
                    title: "",
                    text: "DataObserve drives sustained revenue growth in the CPG sector through insightful analytics and strategic initiatives."
                }
            ]
        },
        {
            title: "FUTURE GROWTH POCKETS IDENTIFIED",
            icon: <CheckCircleOutline sx={{ fontSize: 40, color: '#158aff' }} />,
            points: [
                {
                    title: "",
                    text: "DataObserve identifies future growth pockets within the CPG industry, paving the way for strategic expansion."
                }
            ]
        }
    ];
        ...
        <Box sx={{ py: 8, bgcolor: '#EEEEEE' }}>
            <Container maxWidth={false} sx={{ maxWidth: "1000px" }}>
                <Typography variant="h4" align="center" gutterBottom sx={{ fontWeight: 'bold', textTransform: 'uppercase', mb: 10, color: '#2b2b2b' }}>
                    THE DATAOBSERVE ADVANTAGE IN CPG
                </Typography>
