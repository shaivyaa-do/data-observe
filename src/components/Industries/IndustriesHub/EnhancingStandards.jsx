...
import bgImage from "../../../assets/images/industrial-img.png";
        ...
        >
            <Container maxWidth="lg" sx={{ zIndex: 2, textAlign: "center", position: "relative" }}>
                <Box sx={{ maxWidth: "1200px", mx: "auto" }}>
                    ...
                    >
                        ENHANCED REVENUE AND TRADE PROMOTIONS DECISION-MAKING FOR A CONSUMER GOODS INDUSTRY LEADER VIA A DATA LAKE SOLUTION.
                    </Typography>
                    <Typography
                        variant="body1"
                        sx={{
