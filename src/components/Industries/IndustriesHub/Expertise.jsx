            ...
            <Container maxWidth={false} sx={{ maxWidth: '1000px' }}>
                ...
                <Box sx={{ maxWidth: '800px', mx: 'auto', textAlign: 'center', mb: 8 }}>
                    ...
                    <Typography variant="body1" sx={{ fontFamily: 'Georgia, serif', color: '#2b2b2b' }}>
                        AI services that scale, setting the course of action for Industrial advantage.
                    </Typography>
                </Box>
                ...
                <IndustryBlock
                    title="DO RGM"
                    description="Utilize DataObserve Revenue Growth Management to maintain revenue growth across products, consumer channels, and geographies. Stay ahead of competitors with real-time CPG data insights on pricing, assortment, and distribution."
                    points={[
                ...
                <IndustryBlock
                    title="TRADE PROMOTION EFFECTIVENESS"
                    description="DataObserve Trade Promotion Effectiveness optimizes design and delivery at granular level, keeping your brand equity, sales growth, and channel partnerships intact."
                    points={[
