    ...
    const items = [
        {
            ...
            points: [
                {
                    title: "", // Empty title as the text seems continuous in the image or single bullet
                    text: "Transforming the banking landscape with AI-powered modernization to optimize costs and drive efficiency."
                }
            ]
        },
        {
            title: "HIGHER SATISFACTION QUOTIENT",
            icon: <CheckCircleOutline sx={{ fontSize: 40, color: '#158aff' }} />,
            points: [
                {
                    title: "",
                    text: "Transforming the banking landscape through AI-driven modernization to elevate customer satisfaction levels to new heights."
                }
            ]
        },
        {
            title: "DATED ALGORITHMIC AND ANALYTICS SOLUTIONS",
            icon: <CheckCircleOutline sx={{ fontSize: 40, color: '#158aff' }} />,
            points: [
                {
                    title: "",
                    text: "Transforming the banking landscape by revolutionizing with AI-driven modernization to replace outdated algorithmic and analytics solutions."
                }
            ]
        }
    ];
        ...
        <Box sx={{ py: 8, bgcolor: '#EEEEEE' }}>
            <Container maxWidth={false} sx={{ maxWidth: "1000px" }}>
                <Typography variant="h4" align="center" gutterBottom sx={{ fontWeight: 'bold', textTransform: 'uppercase', mb: 10, color: '#2b2b2b' }}>
                    REVOLUTIONIZING BANKING THROUGH AI-DRIVEN MODERNIZATION
                </Typography>
