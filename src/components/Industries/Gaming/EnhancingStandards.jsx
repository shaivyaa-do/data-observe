...
import bgImage from "../../../assets/images/gaming-img.png";
        ...
        >
            <Container maxWidth="lg" sx={{ zIndex: 2, textAlign: "center", position: "relative" }}>
                <Box sx={{ maxWidth: "1200px", mx: "auto" }}>
                    ...
                    >
                        ELEVATING GAMING INDUSTRY STANDARDS THROUGH SEAMLESS INTEGRATION OF AI AND ANALYTICS.
                    </Typography>
                    <Typography
                        variant="body1"
                        sx={{
                    ...
                    >
                        Leveraging our substantial expertise in cloud consulting and implementation, we aspire to become a trusted partner in advancing the gaming industry.
                    </Typography>
                    <Button
                        variant="contained"
