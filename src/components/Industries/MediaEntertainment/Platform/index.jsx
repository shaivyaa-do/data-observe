                ...
                >
                    ...
                    <Box>
                        <Typography variant="body1" sx={{
                            ...
                            Embrace the paradigm shift in the media and entertainment industry with lightning-fast distribution and extensive storage capacity through cloud migration. Collaborate with DataObserve to enhance the agility, flexibility, and scalability of your content supply chain. Request a demo
                        </Typography>
                        <Button
                            variant="contained"
