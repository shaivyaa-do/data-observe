...
const InfoBottom = () => {
    const items = [
        {
            title: "Boost your time to value",
            ...
            points: [
                {
                    ...
                    text: "Leverage the DataObserve advantage in Travel & Hospitality to accelerate your time to value."
                }
            ]
        },
        {
            ...
            points: [
                {
                    title: "",
                    text: "Unlock the DataObserve advantage in Travel & Hospitality to elevate customer experiences."
                }
            ]
        },
        {
            ...
            points: [
                {
                    title: "",
                    text: "Leverage the DataObserve advantage in travel and hospitality to optimize your efficiency."
                }
            ]
        }
    ];
        ...
        <Box sx={{ py: 8, bgcolor: '#EEEEEE' }}>
            <Container maxWidth={false} sx={{ maxWidth: "1000px" }}>
                <Typography variant="h4" align="center" gutterBottom sx={{ fontWeight: 'bold', textTransform: 'uppercase', mb: 10, color: '#2b2b2b' }}>
                    THE DATAOBSERVE ADVANTAGE IN TRAVEL & HOSPITALITY
                </Typography>
